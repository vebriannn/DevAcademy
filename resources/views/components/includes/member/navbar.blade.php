<div class="container-fluid">
    <nav class="navbar navbar-expand-lg bg-transparent">
        <div class="container-fluid">
            ...
            <span class=""><img src="{{ asset('nemolab/components/member/img/icon-nav.png') }}" alt=""></span>
            </button>
            <div class="d-flex align-items-center mx-auto">
                <a href="{{ route('home') }}" style="text-decoration: none;">
                    <div class="brand-nemolab-icon d-flex align-items-center">
                        <img src="{{ asset('nemolab/components/member/img/logo-nemolab.png') }}" alt="Logo" width="40" height="40"
                            class="d-inline-block align-text-top">
                        <div class="title-navbar-brand ms-2 d-none d-md-block">
            ...
            <div class="register-mobile">
                <a href="{{ route('member.register') }}" class="btn btn-primary px-3 pt-1 pb-1" id="registerBtn">Daftar</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <ul class="navbar-nav d-lg-flex align-items-lg-center gap-lg-4 ps-5">
