                ...
                @foreach($transactions as $transaction)
                    <div class="card mt-3">
                        <div class="card-body d-flex align-items-center">
                            <img alt="Course image" src="{{ asset('storage/images/covers/' . $transaction->course->cover) }}" height="80" width="120" class="cover me-3" />
                            <div class="details">
                                ...
                                <div class="info mt-3">
                                    ...
                                    <p class="status-info" style="color: {{ $transaction->status === 'success' ? 'green' : ($transaction->status === 'pending' ? 'orange' : 'red') }};">
