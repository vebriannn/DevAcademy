        ...
        <main role="main" class="col-lg-9 col-sm-12 ps-4">
            ...
            <div class="table-responsive px-3 py-3">
                ...
                <div class="d-flex justify-content-between px-1 py-1">
                    ...
                    <div class="d-flex">
                        <!-- Custom Pagination -->
                        <button class="pagination mx-1 {{ $superadmins->onFirstPage() ? 'disabled' : '' }}"
                            id="prev-button" {{ $superadmins->onFirstPage() ? 'disabled' : '' }}
                            data-url="{{ $superadmins->previousPageUrl() }}">Previous</button>
                        <button class="pagination mx-1 {{ $superadmins->hasMorePages() ? '' : 'disabled' }}"
                            id="next-button" {{ $superadmins->hasMorePages() ? '' : 'disabled' }}
