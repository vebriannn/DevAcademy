        ...
        <div class="row w-100">
            ...
            <div class="col-3 d-none d-lg-block p-4 rounded-4 text-white" style="background-color: #faa907">
                ...
                <a href="#" class="list-sidebar active">
                    <img src="{{ asset('nemolab/assets/image/datalesson-active.png') }}" alt="" width="30" />
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-9 px-4">
                ...
                <div class="table-responsive px-3 py-3">
                    <div class="btn-group mr-2 w-100 d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{route('admin.lesson.create', $id)}}" class="tambah-data px-2 py-2">Tambah</a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($lessons as $lesson)
                                <tr>
                                    ...
                                    <td>{{ $lesson->video }}</td>
                                    <td>
                                        <a href="{{ route('admin.lesson.edit', $lesson->id) }}" class="me-2"><img
                                                src="{{ asset('nemolab/assets/image/edit.png') }}" alt=""
                                                width="35" height="35"></a>
                                        <a href="{{ route('admin.lesson.delete', $lesson->id) }}"><img
