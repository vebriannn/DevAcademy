...
@section('content-create-data-superadmin')
        ...
        <form class="col-12" action="{{ route('admin.superadmin.store') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="row col-12 mb-3">
                    ...
                    <div class="col-6">
                        <a href="{{ route('admin.superadmin') }}" class="d-block w-100 text-center text-decoration-none py-2 rounded-3 text-white btn-batal" style="background-color: gray">Batal</a>
                    </div>
                </div>
            </div>
        </form>
