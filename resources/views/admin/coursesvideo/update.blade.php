...
@section('content')
    ...
    <div class="card w-75 my-5 p-4 rounded-3" style="border: none !important;">
        ...
        <div class="card-body pt-2">
            <form class="col-12" action="{{ route('admin.course.edit.update', $course->id) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="custom-entryarea">
                            <select id="type" name="type">
                                ...
                                <option value="premium" {{ $course->type == 'premium' ? 'selected' : '' }}>Berbayar</option>
                            </select>
                            @error('type')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                    ...
                    <p class="m-0 mb-1 mt-3">Pilih Alat</p>
