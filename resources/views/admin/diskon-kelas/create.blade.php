...
@section('title', 'Tambah Diskon Kelas')

@section('content')
    <div class="card 5 mt-5 mb-5" style="border: none !important;">
        ...
        <div class="card-body pt-2">
            <form class="col-12" id="formAction" action="{{ route('admin.diskon-kelas.create.store') }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6 mt-4" >
                        <div class="entryarea">
                            <input type="text" id="name" name="kode_diskon" placeholder="" value="{{ old('kode_diskon') }}" />
                    ...
                    <div class="col-6 mt-4" >
                        <div class="entryarea">
                            <input type="number" id="name" name="rate_diskon" placeholder="" value="{{ old('rate_diskon') }}" />
